...
Section InitialTerminal.
  ...
  Let decide_unit_equality (a b : unit) : {a = b} + {~a = b} := left
   ...
   Definition InitialCategory : SmallSpecializedCategory _ :=
     Eval unfold DiscreteCategoryDec in @DiscreteCategoryDec Empty_set decide_empty_equality.
   Definition TerminalCategory : SmallSpecializedCategory _ :=
     Eval unfold DiscreteCategoryDec in @DiscreteCategoryDec unit decide_unit_equality.
End InitialTerminal.
