...
Section Adjunction.
  ...
  (**
    ...
    **)
  Definition AdjunctionUnit (F : SpecializedFunctor C D) (G : SpecializedFunctor D C) :=
    { T : SpecializedNaturalTransformation (IdentitySpecializedFunctor C) (ComposeSpecializedFunctors G F) &
  ...
  (**
    ...
    **)
  Definition AdjunctionCounit (F : SpecializedFunctor C D) (G : SpecializedFunctor D C) :=
    { U : SpecializedNaturalTransformation (ComposeSpecializedFunctors F G) (IdentitySpecializedFunctor D) &
