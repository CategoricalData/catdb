  ...
  Record AdjunctionUnitCounit :=
    {
      ...
      Adjunction_UnitCounitEquation1 : forall Y : C, Compose (ε (F Y)) (F.(MorphismOf) (η Y)) = Identity (F Y);
      Adjunction_UnitCounitEquation2 : forall X : D, Compose (G.(MorphismOf) (ε X)) (η (G X)) = Identity (G X)
    }.
End Adjunction.
