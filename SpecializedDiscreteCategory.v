...
Section DCategory.
  ...
  Definition DiscreteSpecializedCategory : @SpecializedCategory O (fun s d => match s == d return Set with left _ => unit | right _ => Empty_set end).
    refine {|
...
Section InitialTerminal.
  ...
  Definition InitialSpecializedCategory : SmallSpecializedCategory _ :=
    Eval unfold DiscreteSpecializedCategory in DiscreteSpecializedCategory Empty_set decide_empty_equality.
  Definition TerminalSpecializedCategory : SmallSpecializedCategory _ :=
    Eval unfold DiscreteSpecializedCategory in DiscreteSpecializedCategory unit decide_unit_equality.
End InitialTerminal.
