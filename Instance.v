...
Section Schema.
  ...
  Polymorphic Record ProgressiveUpdate (I J : Instance) := {
  ...
  Polymorphic Lemma compose_transferPath : forall s d (p : path S s d) x,
  ...
  Polymorphic Definition translationOf : Translation S TypeSch.
